...
contract DfrancParameters is IDfrancParameters, Ownable, CheckContract, Initializable {
	...
	//@audit Use this in the constructor instead of a function if it can only be called once?
	//@note Can also make variables immutable if used in the constructor
	...
	//@audit Medium - Anyone can call this function and set the parameters back to default arbitrarily
