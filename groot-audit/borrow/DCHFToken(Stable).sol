...
contract DCHFToken is CheckContract, IDCHFToken, Ownable {
	...
	constructor(address _stabilityPoolManagerAddress) ERC20("Groot Stable Coin ", "USDG") {
		checkContract(_stabilityPoolManagerAddress);
		_mint(msg.sender, 100_000_000_000_000_000_000_000_000);  // 100 Million Supply
	...
	//@audit Gas: Initialization of default values - accessing array from storage - post incrementation
