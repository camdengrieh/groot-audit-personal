...
contract AdminContract is Ownable, Initializable {
	string public constant NAME = "AdminContract"; //@audit - Use bytes32 instead of string or remove this variable, it is not used anywhere and is a waste of gas

	bytes32 public constant STABILITY_POOL_NAME_BYTES =
		0xf704b47f65a99b2219b7213612db4be4a436cdf50624f4baca1373ef0de0aac7;
	bool public isInitialized; //@audit - Already using Initializable.sol, so this is not needed
	...
	//@audit  - Use the constructor instead of a function and then make the variables immutable
	...
	function setAddresses(
		...
		require(!isInitialized, "Already initialized"); //@audit Already using Initializable.sol, so this is not needed
